 ...
 */
public class SSEduhubTrackSelectionView extends LinearLayout {

    private final int selectableItemBackgroundResourceId;
    private final LayoutInflater inflater;
    private final CheckedTextView disableView;
    private final CheckedTextView defaultView;
    private final SSEduhubTrackSelectionView.ComponentListener componentListener;
    ...
    @Nullable
    private SSEduhubTrackSelectionView.TrackSelectionListener listener;

    /**
     * Creates a track selection view.
     */
    public SSEduhubTrackSelectionView(Context context) {
        this(context, null);
    }
     ...
     * Creates a track selection view.
     */
    public SSEduhubTrackSelectionView(Context context, @Nullable AttributeSet attrs) {
    ...
    public SSEduhubTrackSelectionView(
        ...
        componentListener = new SSEduhubTrackSelectionView.ComponentListener();
        ...
        disableView =
                (CheckedTextView)
                        inflater.inflate(R.layout.lay_track_selection_checkbox, this, false);
        disableView.setBackgroundResource(selectableItemBackgroundResourceId);
        disableView.setText(R.string.exo_track_selection_none);
        disableView.setTextColor(ContextCompat.getColor(context, R.color.colorAccent));
        ...
        defaultView.setTextColor(ContextCompat.getColor(context, R.color.colorAccent));
    ...
    public void init(
            ...
            @Nullable SSEduhubTrackSelectionView.TrackSelectionListener listener) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                int trackViewLayoutId =
                        enableMultipleChoiceForAdaptiveSelections || enableMultipleChoiceForMultipleOverrides
                                ...
                                : R.layout.lay_track_selection_checkbox;
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            SSEduhubTrackSelectionView.this.onClick(view);
        }
    }
}
